...
<input type="text" name="BuildingNo" id="BuildingNo" value="<?php echo $buildnumber ?>" required><br><br>
<label for="BuildingName">Room Number</label>
<input type="text" name="BuildingName" id="BuildingName" value="<?php echo $buildingname ?>" required><br><br>
